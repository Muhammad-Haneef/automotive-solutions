...
setTimeout(function(){
    ...
    if ($this.hasClass('klbcp-btn-added klbcp-added')) {
	  ...
	  '<strong>' + product_name + '</strong>') + ' <a href="'+ klbcp_vars.page_url + '" class="btn variant-primary btn-rounded"><i class="klb-icon-compare-product-thin"></i> '+ klbcp_vars.view_page_text + '</a><a class="btn variant-primary btn-rounded klbcp-close-message"><i class="klb-icon-xmark"></i> ' + klbcp_vars.close_text + '</a></div></div>');
