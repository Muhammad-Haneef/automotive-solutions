...
class StoreCourierServiceRequest extends BaseFormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            'logo' => 'nullable',
            'title' => 'required|string|max:255|unique:courier_services,title',
            'email' => 'nullable|email|max:255|unique:courier_services,email',
            // 'about' => '',
            'contact_person' => 'nullable|string|max:255',
            'contact_email' => 'nullable|email|max:255|unique:courier_services,contact_email',
            'contact_phone' => 'nullable|string|max:20|unique:courier_services,contact_phone',
