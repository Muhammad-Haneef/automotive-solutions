...
class BrandController extends Controller
{
    ...
    public function store(StoreBrandRequest $request)
    {
        ...
        Brand::create(array_intersect_key($data, array_flip((new Brand())->getFillable())));
    ...
    public function update(UpdateBrandRequest $request, Brand $brand, $id)
    {
        ...
        // Save only fillable fields in the database
        Brand::where('id', $id)->update(array_intersect_key($data, array_flip((new Brand())->getFillable())));
