...
class ShippingClassController extends Controller
{
    ...
    {
        ShippingClass::create($request->only((new ShippingClass())->getFillable()));
        return back()->with([
    ...
    public function trash($id)
    {
        DB::beginTransaction();
        try {
            ShippingClass::findOrFail($id)->delete();
            DB::commit();
            return back()->with([
    ...
    public function restore($id)
    {
        DB::beginTransaction();
        try {
            ShippingClass::withTrashed()->findOrFail($id)->restore();
            DB::commit();
            return back()->with([
    ...
    public function destroy($id)
    {
        DB::beginTransaction();
        try {
            ShippingClass::withTrashed()->findOrFail($id)->forceDelete();
            DB::commit();
            return back()->with([
