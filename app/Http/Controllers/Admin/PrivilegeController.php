...
class PrivilegeController extends Controller
{
    ...
    {
        Privilege::create($request->only((new Privilege())->getFillable()));
        return back()->with([
    ...
    public function trash($id)
    {
        DB::beginTransaction();
        try {
            Privilege::findOrFail($id)->delete();
            DB::commit();
            return back()->with([
    ...
    public function restore($id)
    {
        DB::beginTransaction();
        try {
            Privilege::withTrashed()->findOrFail($id)->restore();
            DB::commit();
            return back()->with([
    ...
    public function destroy($id)
    {
        DB::beginTransaction();
        try {
            Privilege::withTrashed()->findOrFail($id)->forceDelete();
            DB::commit();
            return back()->with([
