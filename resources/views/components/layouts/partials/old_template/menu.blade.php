<div class="vertical-menu" id="sidebar-nav">
    <nav>
        <ul class="vertical-nav">
            <li class=""><a href="shop.html"><span><img src="{{asset('front/img/vertical-menu/1.png')}}" alt="menu-icon"></span>Automotive &amp; Motorcycle<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                <ul class="vertical-nav-dropdown mega-child">
            ...
            <li><a href="shop.html"><span><img src="{{asset('front/img/vertical-menu/3.png')}}" alt="menu-icon"></span>Sports &amp; Outdoors<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                <!-- Vertical Mega-Menu Start -->
                <ul class="vertical-nav-dropdown megamenu first-megamenu">
                    <!-- Single Column Start -->
                    ...
                    <li class="megamenu-img">
                        <a href="shop.html"><img src="{{asset('front/img/vertical-menu/sub-img1.jpg')}}" alt="menu-image"></a>
                        <a href="shop.html"><img src="{{asset('front/img/vertical-menu/sub-img2.jpg')}}" alt="menu-image"></a>
                        <a href="shop.html"><img src="{{asset('front/img/vertical-menu/sub-img3.jpg')}}" alt="menu-image"></a>
                    </li>
                    <!-- Single Megamenu Image End -->
                </ul>
                <!-- Vertical Mega-Menu End -->
            </li>
            <li><a href="shop.html"><span><img src="{{asset('front/img/vertical-menu/6.png')}}" alt="menu-icon"></span>Fashion<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                <!-- Vertical Mega-Menu Start -->
                <ul class="vertical-nav-dropdown megamenu megamenu-two">
                    <!-- Single Column Start -->
                    <li class="single-megamenu">
                        <ul>
            ...
            <li><a href="shop.html"><span><img src="{{asset('front/img/vertical-menu/7.png')}}" alt="menu-icon"></span>Home &amp; Kitchen<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                <!-- Vertical Mega-Menu Start -->
                <ul class="vertical-nav-dropdown megamenu megamenu-two">
                    <!-- Single Column Start -->
                    <li class="single-megamenu">
            ...
            <li><a href="shop.html"><span><img src="{{asset('front/img/vertical-menu/4.png')}}" alt="menu-icon"></span>Phones &amp; Tablets<i class="fa fa-angle-right" aria-hidden="true"></i>
                </a>
                <!-- Vertical Mega-Menu Start -->
                <ul class="vertical-nav-dropdown megamenu megamenu-two">
                    <!-- Single Column Start -->
            ...
            <li><a href="shop.html"><span><img src="{{asset('front/img/vertical-menu/6.png')}}" alt="menu-icon"></span>TV &amp; Video<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                <!-- Vertical Mega-Menu Start -->
                <ul class="vertical-nav-dropdown megamenu megamenu-two">
                    <!-- Single Column Start -->
                    <li class="single-megamenu">
            ...
            <li><a href="shop.html"><span><img src="{{asset('front/img/vertical-menu/8.png')}}" alt="menu-icon"></span>Fruits &amp; Veggies</a></li>
            <li><a href="shop.html"><span><img src="{{asset('front/img/vertical-menu/9.png')}}" alt="menu-icon"></span>Computer &amp; Laptop</a></li>
            <li><a href="shop.html"><span><img src="{{asset('front/img/vertical-menu/10.png')}}" alt="menu-icon"></span>Meat &amp; Seafood</a></li>
            <!-- More Categoies Start -->
            <li id="cate-toggle" class="category-menu v-cat-menu">
                <ul>
                    <li class="has-sub"><a href="#">More Categories</a>
                        <ul class="category-sub">
                            <li><a href="shop.html"><span><img src="{{asset('front/img/vertical-menu/11.png')}}" alt="menu-icon"></span>Accessories</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
