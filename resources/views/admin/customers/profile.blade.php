                        ...
                        <div class="user-image">
                            <div class="avatar">
                                <div class="common-align">
                                    <div><img id="output" src="<?= assets('img') ?>placeholder_184x184.jpg" alt="Profile Image">
                                                        ...
                                                        <li class="d-flex">
                                                            ...
                                                            <div class="w-100 ms-3">
                                                                ...
                                                                <div class="recent-images">
                                                                    <ul>
                                                                        <li>
                                                                            <div class="recent-img-wrap"><img src="<?= assets('img') ?>dashboard/order/sub-product/4.png" alt="chair"></div>
                                                                        </li>
                                                                        <li>
                                                                            <div class="recent-img-wrap"><img src="<?= assets('img') ?>dashboard/order/sub-product/8.png" alt="neckless"></div>
                                                                        </li>
                                                                        <li>
                                                                            <div class="recent-img-wrap"><img src="<?= assets('img') ?>dashboard/order/sub-product/11.png" alt="slipper"></div>
                                                                        </li>
                                                                        <li>
                                                                            <div class="recent-img-wrap"><img src="<?= assets('img') ?>dashboard/order/sub-product/7.png" alt="earings"></div>
                                                                        </li>
                                                                        <li>
                                                                            <div class="recent-img-wrap"><img src="<?= assets('img') ?>dashboard/order/sub-product/3.png" alt="men t-shirt"></div>
                                                                        </li>
                                                                        <li>
                                                                            <div class="recent-img-wrap"><img src="<?= assets('img') ?>dashboard/order/sub-product/9.png" alt="men shorts"></div>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="w-100 ms-3">
                                                                ...
                                                                <div class="project-teammate">
                                                                    <ul class="common-f-start">
                                                                        <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Sarah Wilson"><img class="common-circle" src="<?= assets('img') ?>dashboard-11/user/11.jpg" alt="user"></li>
                                                                        <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Richard Taylor"><img class="common-circle" src="<?= assets('img') ?>dashboard-11/user/9.jpg" alt="user"></li>
                                                                        ...
                                                                        <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Jessica Anderson"><img class="common-circle" src="<?= assets('img') ?>dashboard-11/user/3.jpg" alt="user"></li>
                                                            ...
                                                            <div class="list-box title-line-primary">
                                                                <div class="header-top"><span class="badge badge-light-primary">Pending</span>
                                                                    <p class="mb-0 c-o-light">
                                                                        <svg class="me-2">
                                                                            <use href="<?= assets('svg') ?>vector-calendar"></use>
                                                                        </svg>06 Nov, 2024
                                                                    </p>
                                                                </div>
                                                                <div class="project-body">
                                                                    <div class="common-f-start"><img class="img-fluid" src="<?= assets('img') ?>project/list/1.png" alt="dashboard">
                                                                        <div>
                                                    ...
                                                    <div class="col-xxl-4 col-md-6 box-col-6 xl-50">
                                                        <div class="progress-project-box">
                                                            <div class="list-box title-line-success">
                                                                ...
                                                                <div class="project-body">
                                                                    <div class="common-f-start"><img class="img-fluid" src="<?= assets('img') ?>project/list/2.png" alt="application">
                                                                        <div>
                                                    ...
                                                    <div class="col-xxl-4 col-md-6 box-col-6 xl-50">
                                                        <div class="progress-project-box">
                                                            <div class="list-box title-line-primary">
                                                                ...
                                                                <div class="project-body">
                                                                    <div class="common-f-start"><img class="img-fluid" src="<?= assets('img') ?>project/list/8.png" alt="e-commerce web">
                                                                        <div>
                                                    ...
                                                    <div class="col-xxl-4 col-md-6 box-col-6 xl-50">
                                                        <div class="progress-project-box">
                                                            <div class="list-box title-line-success">
                                                                ...
                                                                <div class="project-body">
                                                                    <div class="common-f-start"><img class="img-fluid" src="<?= assets('img') ?>project/list/11.png" alt="application">
                                                                        <div>
                                                    ...
                                                    <div class="col-xxl-4 col-md-6 box-col-6 xl-50">
                                                        <div class="progress-project-box">
                                                            <div class="list-box title-line-warning">
                                                                ...
                                                                <div class="project-body">
                                                                    <div class="common-f-start"><img class="img-fluid" src="<?= assets('img') ?>project/list/12.png" alt="landing page">
                                                                        <div>
                                                    ...
                                                    <div class="col-xxl-4 col-md-6 box-col-6 xl-50">
                                                        <div class="progress-project-box">
                                                            <div class="list-box title-line-success">
                                                                ...
                                                                <div class="project-body">
                                                                    <div class="common-f-start"><img class="img-fluid" src="<?= assets('img') ?>project/list/10.png" alt="application">
                                                                        <div>
                                                    ...
                                                    <div class="col-xxl-4 col-md-6 box-col-6 xl-50">
                                                        <div class="progress-project-box">
                                                            <div class="list-box title-line-warning">
                                                                ...
                                                                <div class="project-body">
                                                                    <div class="common-f-start"><img class="img-fluid" src="<?= assets('img') ?>project/list/9.png" alt="landing page">
                                                                        <div>
                                                    ...
                                                    <div class="col-xxl-4 col-md-6 box-col-6 xl-50">
                                                        <div class="progress-project-box">
                                                            <div class="list-box title-line-success">
                                                                ...
                                                                <div class="project-body">
                                                                    <div class="common-f-start"><img class="img-fluid" src="<?= assets('img') ?>project/list/7.png" alt="application">
                                                                        <div>
                                                    ...
                                                    <div class="col-xxl-4 col-md-6 box-col-6 xl-50">
                                                        <div class="progress-project-box">
                                                            <div class="list-box title-line-primary">
                                                                ...
                                                                <div class="project-body">
                                                                    <div class="common-f-start"><img class="img-fluid" src="<?= assets('img') ?>project/list/6.png" alt="project">
                                                                        <div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="user-notifications">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <div> <img class="img-fluid" src="<?= assets('img') ?>dashboard-11/user/12.jpg" alt="user">
                                                                <div>
                                                        ...
                                                        <li>
                                                            <div> <img class="img-fluid" src="<?= assets('img') ?>dashboard-11/user/1.jpg" alt="user">
                                                                <div>
                                                        ...
                                                        <li>
                                                            <div> <img class="img-fluid" src="<?= assets('img') ?>dashboard-11/user/5.jpg" alt="user">
                                                                <div>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <div> <img class="img-fluid" src="<?= assets('img') ?>dashboard-11/user/2.jpg" alt="user">
                                                                <div>
                                                        ...
                                                        <li>
                                                            <div> <img class="img-fluid" src="<?= assets('img') ?>dashboard-11/user/4.jpg" alt="user">
                                                                <div>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <div> <img class="img-fluid" src="<?= assets('img') ?>dashboard-11/user/7.jpg" alt="user">
                                                                <div>
