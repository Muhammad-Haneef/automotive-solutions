      ...
      <div class="col-sm-3">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <x-admin.form.radio-buton-list ref="blog_category_id" :options="$categories" />
            @else
            <p>
              Please <a href="{{ url('/admin/blog-categories') }}">add a blog category</a> to select one.
            </p>
            @endif
          </div>
        </div>
        <div class="card">
          ...
          <div class="card-body">
            ...
            <x-admin.form.checkbox-list ref="tags[]" :options="$tags" />
            @else
            <p>
              Please <a href="{{ url('/admin/tags') }}">add tags</a> to select them.
            </p>
            @endif
          </div>
        </div>
