                ...
                <div class="d-flex  align-items-center mb-3">
                  ...
                  <div class="flex-grow-1 mt-0">
                    <h5>
                      ...
                      {{ $row->title }}
                      @else
                      <span class="first_name_0">Example </span><span class="last_name_0">Brand</span>
                      @endif
                    </h5>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row gy-3">
                ...
                <x-admin.form.input ref="title" title="Name" type="text" value="{{$row ? $row->title : old('title')}}" required=1 class="col-md-6" />
                <x-admin.form.input ref="slug" title="Slug" type="text" value="{{$row ? $row->slug : old('slug')}}" required=1 class="col-md-6" />
                <x-admin.form.input ref="address" title="Address" type="text" value="{{$row ? $row->address : old('address')}}" required=1 class="col-md-9" />
                <x-admin.form.input ref="email" title="Email" type="email" value="{{$row ? $row->email : old('email')}}" required=1 class="col-md-3" />
                <x-admin.form.textarea ref="about" title="About Brand" value="{{$row ? $row->about : old('about')}}" />
