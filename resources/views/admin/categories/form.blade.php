        ...
        <div class="card">
          ...
          <div class="card-body add-post">
            <div class="row g-3">
              ...
              <x-admin.form.dropdown ref="parent_id" title="Parent category" :options="$categories" selected="{{$row ? $row->parent_id : old('parent_id')}}" />
              ...
              <x-admin.form.dropdown
                ref="show_description"
                title="Show Description"
                :options="get_yes_no_options()"
                selected="{{$row ? $row->show_description : old('show_description', 1)}}" class="col-md-4" />


              <x-admin.form.dropdown
                ref="show_description_at"
                title="Show Description At"
                :options="[
                            (object) ['id' => 0, 'title' => 'Top of Page'],
                            (object) ['id' => 1, 'title' => 'Bottom of Page']
                          ]"
                :selected="$row ? $row->show_description_at : old('show_description_at', 1)"
                class="col-md-4" />
