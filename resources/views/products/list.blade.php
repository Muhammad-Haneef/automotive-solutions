            ...
            <div class="row">
                <div class="col-6 col-sm-6 col-md-3 col-lg-4">
                  <div class="product-card my-2">
                    ...
                    <span class="product-wishlist position-absolute">
                      <img src="assets/images/wishlist.svg" alt="" class="img-fluid">
                    </span>
                    <div class="product-img">
                      <img src="assets/images/products/01-56.webp" alt="" class="img-fluid">
                    </div>
                ...
                <div class="col-6 col-sm-6 col-md-3 col-lg-4">
                  <div class="product-card my-2">
                    ...
                    <div class="product-img">
                      <img src="assets/images/products/01-55.webp" alt="" class="img-fluid">
                    </div>
                    <div class="product-rating d-flex align-item-center mb-2">
                      <div class="rating small">
                          <i class="fas fa-star"></i>
                ...
                <div class="col-6 col-sm-6 col-md-3 col-lg-4">
                  <div class="product-card my-2">
                    ...
                    <div class="product-img">
                      <img src="assets/images/products/01-52.webp" alt="" class="img-fluid">
                    </div>
                    <div class="product-rating d-flex align-item-center mb-2">
                      <div class="rating small">
                          <i class="fas fa-star"></i>
                ...
                <div class="col-6 col-sm-6 col-md-3 col-lg-4">
                  <div class="product-card my-2">
                      ...
                      <div class="product-img">
                        <img src="assets/images/products/01-51.webp" alt="" class="img-fluid">
                      </div>
                      <div class="product-rating d-flex align-item-center mb-2">
                        <div class="rating small">
                            <i class="fas fa-star"></i>
                ...
                <div class="col-6 col-sm-6 col-md-3 col-lg-4">
                  <div class="product-card my-2">
                          ...
                          <div class="product-img">
                            <img src="assets/images/products/01-50.webp" alt="" class="img-fluid">
                          </div>
                          <div class="product-rating d-flex align-item-center mb-2">
                            <div class="rating small">
                                <i class="fas fa-star"></i>
                ...
                <div class="col-6 col-sm-6 col-md-3 col-lg-4">
                  ...
                  <div class="product-img">
                    <img src="assets/images/products/01-59.webp" alt="" class="img-fluid">
                  </div>
                ...
                <div class="col-6 col-sm-6 col-md-3 col-lg-4">
                  <div class="product-card my-2">
                    ...
                    <div class="product-img">
                      <img src="assets/images/products/01-30.webp" alt="" class="img-fluid">
                    </div>
                ...
                <div class="col-6 col-sm-6 col-md-3 col-lg-4">
                    ...
                    <div class="product-img">
                      <img src="assets/images/products/01-43.webp" alt="" class="img-fluid">
                    </div>
                ...
                <ul class="pagination     justify-content-center">
                  <li class="page-item">
                    <a href="#" class="page-link">
                      <svg width="20px" height="20px" viewBox="0 0 1024 1024" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000" transform="rotate(0)"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M768 903.232l-50.432 56.768L256 512l461.568-448 50.432 56.768L364.928 512z" fill="#000000"></path></g></svg>
                    </a>
                  </li>
                  ...
                  <li class="page-item">
                    <a class="page-link" href="#">
                      <svg width="20px" height="20px" viewBox="0 0 1024 1024" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000" transform="rotate(180)"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M768 903.232l-50.432 56.768L256 512l461.568-448 50.432 56.768L364.928 512z" fill="#000000"></path></g></svg>
                    </a>
                  </li>
                </ul>
              </nav>
