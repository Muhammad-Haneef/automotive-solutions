...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->foreignId('brand_id')->nullable()->default(0)->index();
            $table->foreignId('warehouse_id')->nullable()->default(0)->index();
            $table->foreignId('shipping_class_id')->nullable()->default(0)->index();
