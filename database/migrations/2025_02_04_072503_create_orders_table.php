...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->foreignId('vendor_id')->default(0)->index();
            $table->foreignId('order_source_id')->default(0)->index();
            $table->foreignId('coupon_id')->default(0)->index();
            $table->foreignId('confirmed_by')->default(0);
            $table->foreignId('status_id')->default(0)->index();

            $table->foreignId('shipping_address_id')->default(0)->index();
            $table->foreignId('billing_address_id')->default(0)->index();
            ...
            $table->decimal('advance', 10, 2)->default(0.0);
            $table->decimal('discount', 10, 2)->default(0.0);
            $table->decimal('tax', 10, 2)->default(0.0);
            $table->decimal('redeem_amount', 10, 2)->default(0.0);
             ...
             */
            $table->foreignId('shipper_id')->default(0)->index();
            ...
            $table->decimal('commission_fee', 10, 2)->default(0.0);
            $table->decimal('vendor_earnings', 10, 2)->default(0.0);
